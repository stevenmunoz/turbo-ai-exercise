...
This challenge simulates a real client engagement. You’ll take a fuzzy vision from a non-technical founder (see the [conversation attached below](Turbo%20AI%20Product%20Manager%20Challenge%20e0838014b1b1828f80cd01cde6e28b54.md)) and turn it into something clear, scoped, and buildable — just like we do every day at Turbo AI. 

## **The Situation**

Alex runs a medical supply distribution company currently managing patient orders through a complex Excel spreadsheet. She wants to build a web-based internal tool to replace it. You'll find a transcript of your initial conversation with Alex below.

## **Your Goals**

Alex's vision is scattered and incomplete. Your job is to:

- Understand the real problem - What does Alex actually need vs. what she thinks she wants?
- Propose a phased approach - Break the full vision into 2-week sprints (assume you're working with one full-stack engineer)
- Design Sprint 1 - Create a prototype of something the team will actually love using
- Present to the client - Record a video sharing your proposal with the client

# **📘 The Deliverables**

- **Clickable Prototype** (please provide the link)
...
- **10-Minute Video** (please provide a link to the video hosted on YouTube or Loom)
...
- **Using AI is encouraged:** We welcome and encourage you to use **AI tools** to enhance and speed up your process. Please, let us know in your written deliverable what tools you used and how did you use them.

# 💯 **Criteria**

We’ll assess your work based on the following criteria:
...
When you’re done, send your deliverable to [camila@turbotime.io](mailto:camila@turbotime.io)
